...
object EphemeralSaySkill : Skill("skill.ephemeral_say", serverOnly = true, requiredPermissionsSelf = listOf(Permission.MESSAGE_MANAGE, Permission.MESSAGE_ATTACH_FILES)) {
